  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center text-center bg-[#121a2eff] text-[#f7fbfc] p-4 z-1 overflow-hidden background-gradient">
      ...
      <div className="intro-content-container z-10 max-w-2xl mx-auto space-y-6">
        ...
        <p className="relative text-lg font-light z-2">on November 6<sup>th</sup>, 2026</p>
        <a href="#rsvp" className="relative text-2xl bg-white text-gray-900 font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-gray-300 transition duration-300 z-2 inline-flex items-center mb-6">Save the Date</a><br/>
        <a href="#registry" className="relative hover:underline transition duration-300 z-2 inline-flex items-center">View Registry</a>
      </div>
    </section>
  );
};

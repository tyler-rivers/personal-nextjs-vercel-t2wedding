...
const RegistrySection = () => (
  <section id="registry" className="text-center">
    ...
    <p className="max-w-2xl mx-auto mb-8">
      Your presence at our wedding is the greatest gift of all. However, should you wish to honor us with a gift, we would prefer a donation to our Honeymoon fund - we are fortunate enough to have all the sheets and stand mixers and other housewares that swe can use.
    </p>
